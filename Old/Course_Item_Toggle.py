# -*- coding: utf-8 -*-
"""
Created on Sun Apr 27 00:34:15 2014
...
class Course_Item_Toggle(BoxLayout):
	...
	def __init__(self,course,**kwargs):
		...
		self.add_button = ToggleButton(text='Add to Planner', size_hint=(.66,1))
		self.details_button = Button(text='Details',on_press=self.open_pop_up, size_hint=(.34,1))		
		self.options.add_widget(self.add_button)
		if self.add_button.state == 'down':
                  self.add_button.bind (on_press = add_to_planner)
