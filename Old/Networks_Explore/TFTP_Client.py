...
# TFTP utilizes UDP. Thus, some code from UDP (previous lab) is included
...
# At the beginning of each packet is the oridinal
# The type of the packed is defined by the ordinal value
...
class TFTP(object):
    ...
    # The WRQ and DATA packets are acknowledged by Acknowledge (ACK)
    ...
    # If an error arrises with WRQ and DATA, an ERROR packet is sent
...
class TFTPCommandInterpreter(TFTPClient):
    ...
    # Help function that lists all possible actions of the Client
